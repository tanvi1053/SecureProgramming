...
class Server:
    ...
    async def handler(self, websocket, path):
        try:
            ...
            print("Connection closed, removing client...")
    ...
    async def process_signed_data(self, websocket, message):
        if message["data"]["data"]["type"] == "hello":
            ...
            if username in self.public_keys:
                ...
                return  # Exit the method to prevent adding the client
    ...
    async def remove_client(self, websocket):
        ...
        if client_key in self.connected_clients:
            ...
            # Attempt to find the username associated with this client
            for user, address in list(self.client_key.items()):
        ...
        if username:
            ...
            print("No username associated with this client.")
    ...
    async def run(self, host=WEBSOCKET_ADDRESS, port=WEBSOCKET_PORT):
